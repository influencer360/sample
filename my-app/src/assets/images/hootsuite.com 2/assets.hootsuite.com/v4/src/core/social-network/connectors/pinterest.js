...
var ADD_URL = hs.util.getUrlRoot() + '/app/social-network/add?type=PINTEREST&flowType=MODALS';
...
export default ConnectorBase.extend({
    cancelConnectMessage: translation._("You must sign in and allow Hootsuite to integrate with Pinterest"),
    ...
    doConnect: function (options) {
        ...
        var promise = authenticator.start(AUTH_URL, {direct: true, width: 670, height: 600});
