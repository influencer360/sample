...
var ADD_URL = hs.util.getUrlRoot() + '/app/social-network/add?type=THREADS&flowType=MODALS';
...
export default ConnectorBase.extend({
    cancelConnectMessage: translation._("You must sign in and allow Hootsuite to integrate with Threads"),
