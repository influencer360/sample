...
var getTitle = function () {
    if (hasPostableSocialNetworks()) {
        return translation._('Select social accounts');
    } else {
        return translation._('Add social accounts');
    }
};

var getDescription = function () {
    if (hasPostableSocialNetworks()) {
        return translation._('Select one or more social network accounts to publish to. Publishing to multiple accounts increases your reach.');
    } else {
